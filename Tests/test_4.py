...
class TestLowProduct(unittest.TestCase):
    ...
    def test_low_product(self):
        ...
        lowest_product_name, lowest_product_price = lowest_price.get_all_prices()

        self.assertIsInstance(lowest_product_name, str, "Product name with the lowest price is not a string")
        self.assertIsInstance(lowest_product_price, str, "Product price with the lowest price is not a string")
        print("PASS")
